...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleRestaurantNotFoundException(OrderNotFoundException e){
    ...
    @ExceptionHandler(OrderCannotChangeStatus.class)
    public ResponseEntity<ErrorResponseDto> handleRestaurantNotFoundException(OrderCannotChangeStatus e){
